...
from hummingbot.connector.exchange.pibase.pibase_api_user_stream_data_source import PibaseAPIUserStreamDataSource
from hummingbot.connector.exchange.pibase.pibase_auth import PibaseAuth
...
class PibaseExchange(ExchangePyBase):
    DEFAULT_DOMAIN = ""
    ...
    def authenticator(self):
        return PibaseAuth(
            api_key=self._pibase_api_key,
            secret_key=self._pibase_secret_key,
    ...
    def _create_order_book_data_source(self) -> OrderBookTrackerDataSource:
        return PibaseAPIOrderBookDataSource(
    ...
    def _create_user_stream_data_source(self) -> UserStreamTrackerDataSource:
        return PibaseAPIUserStreamDataSource(
            auth=self._auth,
            trading_pairs=self._trading_pairs,
            connector=self,
            api_factory=self._web_assistants_factory,
