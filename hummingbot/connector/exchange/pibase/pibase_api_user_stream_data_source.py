...
if TYPE_CHECKING:
    from hummingbot.connector.exchange.pibase.pibase_exchange import PibaseExchange


class PibaseAPIUserStreamDataSource(UserStreamTrackerDataSource):
    ...
    def __init__(self,
                 ...
                 connector: 'PibaseExchange',
                 api_factory: WebAssistantsFactory,
                 domain: str = CONSTANTS.DEFAULT_DOMAIN):
        super().__init__()
        self._api_factory = api_factory
        self._auth: PibaseAuth = auth
